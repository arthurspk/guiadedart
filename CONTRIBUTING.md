# Como contribuir com o Guia de Dart
...
3. **Descrição de 1 linha** dizendo o que é e por que vale o clique. Se o conteúdo for pago, diga isso na própria descrição (ex.: "Curso pago da Alura").
...
6. **Foco no tema:** este é um guia sobre a linguagem **Dart**. Conteúdo puramente sobre widgets/UI do Flutter, sem relação com a linguagem em si, pertence ao [Guia de Flutter](https://github.com/arthurspk/guiadeflutter).
...
1. Faça um fork e crie uma branch a partir da `main` (ex.: `feat/novo-curso-dart`).
2. Edite o `README.md`.
